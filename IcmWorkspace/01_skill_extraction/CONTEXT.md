...
1. **Target Job Title**
2. **Key Technical Skills** (e.g. programming languages, frameworks, developer tools, database systems, cloud architectures)
3. **Core Soft Skills & Methodologies** (e.g. agile, scrum, communication, customer support, SLA, troubleshooting)
4. **Key Responsibilities & Tasks** (what the person does daily)
