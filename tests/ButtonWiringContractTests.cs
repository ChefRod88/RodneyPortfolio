...
public class ButtonWiringContractTests
{
    ...
    public static IEnumerable<object[]> ButtonAndResponsiveContractCases()
    {
        var cases = new (string RelativePath, string CaseName, string ExpectedToken)[]
        {
            ...
            ("wwwroot/js/layout.js", "layout-scroll-reveal-observer", "document.querySelectorAll(\".rc-fade\").forEach((el) => rcObserver.observe(el))"),
            ("wwwroot/js/layout.js", "layout-faq-accordion-query", "document.querySelectorAll(\".faq-q\").forEach((btn) => {"),
            ("wwwroot/js/layout.js", "layout-faq-accordion-close", "b.nextElementSibling?.classList.remove(\"open\")"),

            // Index page button and action wiring (45)
            ("Pages/Index.cshtml", "index-hero-title", "<h1 class=\"title\">Rodney Chery</h1>"),
            ...
            ("Pages/Index.cshtml", "index-contact-email-link", "href=\"mailto:rodney@globalrcdev.com\" class=\"contact-item\""),
            ...
            ("wwwroot/js/quote-form.js", "index-quote-submit-fetch", "fetch(form.action, {"),
            ("wwwroot/js/quote-form.js", "index-quote-submit-method", "method: \"POST\","),
            ("wwwroot/js/quote-form.js", "index-quote-submit-header", "headers: { \"X-Requested-With\": \"XMLHttpRequest\" }"),
            ("wwwroot/js/quote-form.js", "index-quote-submit-hide-fields", "formFields.forEach((el) => (el.style.display = \"none\"));"),
            ("wwwroot/js/quote-form.js", "index-quote-submit-success", "document.getElementById(\"quoteSuccess\").style.display = \"block\";"),
            ("wwwroot/js/quote-form.js", "index-quote-submit-disable", "submitBtn.disabled = true;"),
            ...
            ("Pages/Faq.cshtml", "faq-cta-email-link", "<a href=\"mailto:rodney@globalrcdev.com\" class=\"btn btn-outline-dark faq-btn-ghost\">Email Directly</a>"),
            ...
            ("wwwroot/css/site.css", "faq-answer-open-style", ".faq-a.open { display: block; }"),
            ("wwwroot/css/site.css", "faq-chevron-rotation-style", ".faq-q[aria-expanded=\"true\"] .faq-chevron { transform: rotate(90deg); }"),
            ("wwwroot/css/site.css", "faq-cta-buttons-style", ".faq-cta-btns { display: flex;"),
            ("wwwroot/css/site.css", "faq-mobile-media-query", "@media (max-width: 768px) {"),
