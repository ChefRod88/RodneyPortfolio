...
public class PortalPaymentWiring500Tests
{
    ...
    public static IEnumerable<object[]> PortalAndPaymentContractCases()
    {
        var baseCases = new (string RelativePath, string CaseName, string ExpectedToken)[]
        {
            ...
            ("Views/Portal/Dashboard.cshtml", "dash-support-tab", "showTab('support', this)"),
            ...
            ("Views/Portal/Dashboard.cshtml", "dash-create-intent-endpoint", "/Portal/Dashboard/CreatePaymentIntent"),
            ("Views/Portal/Dashboard.cshtml", "dash-confirm-endpoint", "/Portal/Dashboard/ConfirmPayment"),
            ("Views/Portal/Dashboard.cshtml", "dash-cashapp-endpoint", "/Portal/Dashboard/CashAppPending"),
            ("Views/Portal/Dashboard.cshtml", "dash-stripe-js", "const stripe = Stripe(\"@Model.StripePublishableKey\")"),
            ("Views/Portal/Dashboard.cshtml", "dash-token-header", "\"RequestVerificationToken\": csrf"),
            ("Views/Portal/Dashboard.cshtml", "dash-reload", "setTimeout(() => { closePaymentModal(); location.reload(); }, 2500);"),
